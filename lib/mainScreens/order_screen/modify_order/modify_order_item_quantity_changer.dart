...
class ModifyOrderItemQuantityChanger extends StatefulWidget {
  final String storeID;
  final AddToCartItem addToCartItem;
  final ValueChanged<int> onQuantityChanged;

  const ModifyOrderItemQuantityChanger({
  ...
  @override
  _ModifyOrderItemQuantityChangerState createState() => _ModifyOrderItemQuantityChangerState();
}

class _ModifyOrderItemQuantityChangerState extends State<ModifyOrderItemQuantityChanger> {
  late int quantity;
