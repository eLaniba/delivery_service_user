...
class ModifyOrderItemCard extends StatefulWidget {
  final Item item;
  final Stores store;

  const ModifyOrderItemCard({
    Key? key,
    required this.store,
    required this.item,
  }) : super(key: key);
  ...
  @override
  State<ModifyOrderItemCard> createState() => _ModifyOrderItemCardState();
}

class _ModifyOrderItemCardState extends State<ModifyOrderItemCard> {
