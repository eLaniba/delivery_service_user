...
class MessageStoreScreen extends StatefulWidget {
  const MessageStoreScreen({super.key});

  @override
  State<MessageStoreScreen> createState() => _MessageStoreScreenState();
}

class _MessageStoreScreenState extends State<MessageStoreScreen> {
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              final filteredChats = docs.where((chat) {
                return chat.partnerRoleFor?[currentUserId] == 'store';
              }).toList();
                ...
                itemBuilder: (context, index) {
                  ...
                  return PartnerListTile(
                    ...
                    onTap: () {
                      ...
                      final partnerRole = chat.roles?[partnerId] ?? 'store';
